            ...
            <div className="w-full max-w-6xl flex justify-between items-start mb-14">
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative w-24 h-24">
                        <img src={predictiveAnalytics} alt="analysis" className='w-16' />
                        <img src={businessMan} alt="man" className="w-16 h-auto drop-shadow-md" />
                        <img src={webAnalytics} alt="chart" className="absolute pt-4 right-24 top-0 w-16 h-auto" />
                    </div>
